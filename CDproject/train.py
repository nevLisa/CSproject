...
def main():
    ...
    JSON_DIR = "C:/Users/dasd8/PycharmProjects/CDproject/data/라벨링데이터"
    IMAGE_DIR = "C:/Users/dasd8/PycharmProjects/CDproject/data/원천데이터"
    ...
    for epoch in range(EPOCHS):
        ...
        for images, labels in progress_bar:
            ...
            # [수정] 리스트 구조에 맞게 순서(0번, 1번)로 텐서를 꺼내 장치(GPU/CPU)로 보냅니다.
